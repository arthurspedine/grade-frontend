  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        green:
          'bg-green-400 text-primary shadow-sm hover:bg-green-500/95 dark:bg-green-700 dark:hover:bg-green-800/95',
        blue: 'bg-bluecolor text-white shadow-sm hover:bg-blue-600/95',
        purple:
          'bg-purple-600 text-white shadow-sm hover:bg-purple-700/95 dark:bg-purple-700 dark:hover:bg-purple-800/95',
        secondary:
